...
exports.clearDatabaseRouter = void 0;
const express_1 = require("express");
const db_1 = require("../db/db");
exports.clearDatabaseRouter = (0, express_1.Router)({});
exports.clearDatabaseRouter.delete('/all-data', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
